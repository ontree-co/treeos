...
DROP INDEX IF EXISTS idx_system_vital_logs_timestamp;

DROP TABLE IF EXISTS docker_operation_logs;
DROP TABLE IF EXISTS docker_operations;
DROP TABLE IF EXISTS system_vital_logs;
