...
if [ "$RELEASE_TYPE" = "help" ] || [ -z "$RELEASE_TYPE" ]; then
    ...
    echo "              v1.0.0 → v1.0.1-beta.1"
    echo "              v1.0.0-beta.13 → v1.0.1-beta.1"
    echo ""
    echo "  minor-beta  Start beta for next minor version"
    echo "              v1.0.0 → v1.1.0-beta.1"
    echo "              v1.0.0-beta.13 → v1.1.0-beta.1"
    echo ""
    echo "  major-beta  Start beta for next major version"
    echo "              v1.0.0 → v2.0.0-beta.1"
    echo "              v1.0.0-beta.13 → v2.0.0-beta.1"
    echo ""
    ...
    echo ""
    echo "NOTES:"
    echo "  - Beta versions are pre-releases (v1.0.0-beta.1 < v1.0.0)"
