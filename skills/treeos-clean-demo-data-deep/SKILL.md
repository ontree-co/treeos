---
name: treeos-clean-demo-data-deep
description: Deep clean ALL TreeOS demo mode data, including Docker containers and images, with explicit confirmation.
---
...
!./skills/treeos-clean-demo-data-deep/run.sh
...
- Use the non-interactive script `skills/treeos-clean-demo-data-deep/run.sh` after confirmation
