---
name: treeos-clean-production-data-deep
description: Deep clean ALL TreeOS production data including shared folders, with sudo guidance and explicit confirmation.
---
...
**To confirm this destructive operation, please type "yes" when prompted.**
...
```bash
sudo ./skills/treeos-clean-production-data-deep/run.sh
```
...
- Use the non-interactive script `skills/treeos-clean-production-data-deep/run.sh` after confirmation
