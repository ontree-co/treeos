---
name: treeos-setup-production-cloud-cpu
...
**DO NOT** copy or create any setup scripts. The production setup script already exists in the repository at `skills/treeos-setup-production-cloud-cpu/run.sh`. Always reference and use this existing script. Never create duplicates or copies.
...
!echo "sudo ./skills/treeos-setup-production-cloud-cpu/run.sh"
!echo ""
