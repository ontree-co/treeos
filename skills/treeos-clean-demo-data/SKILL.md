---
name: treeos-clean-demo-data
description: Clean all TreeOS demo mode data while preserving shared models and requiring explicit confirmation.
---
...
!./skills/treeos-clean-demo-data/run.sh
...
- Use the non-interactive script `skills/treeos-clean-demo-data/run.sh` after confirmation
